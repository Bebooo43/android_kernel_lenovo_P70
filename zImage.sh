...
cp ~/kernel-3.10/out/arch/arm64/boot/Image.gz-dtb ~/Kitchen/boot/boot.img-kernel
cp ~/kernel-3.10/out/arch/arm64/boot/Image.gz-dtb ~/Kitchen/boot_vdt/boot.img-kernel
cd
